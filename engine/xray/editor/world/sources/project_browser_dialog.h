...
namespace editor {
	...
	{
	public:
		project_browser_dialog(editor_ide^ ide)
		:m_editor_ide(ide)
		{
			InitializeComponent	();
			in_constructor		();
...
#pragma endregion
		...
		private:
			...
			void					setup_resources_path		( System::String^ path );
			void					browse_down					( System::String^ folder );
			void					browse_back					( );
			void					initialize_dialog			( bool b_save_mode, System::String^ resources_path, System::String^ focused_item );
