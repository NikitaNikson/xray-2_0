...
namespace dialog_editor {
	...
	{
	public:
						command_change_node_string_table	(dialog_hypergraph^ h, dialog_graph_node^ n, System::String^ new_str, System::String^ new_text, System::String^ old_str, System::String^ old_text);
