...
void n_ary_tree_animation_node::accept	( n_ary_tree_visitor& visitor )
{
	visitor.visit		( *this );
}

void n_ary_tree_animation_node::accept( n_ary_tree_double_dispatcher& dispatcher, n_ary_tree_base_node& node )
{
...
void n_ary_tree_animation_node::visit	( n_ary_tree_double_dispatcher& dispatcher, n_ary_tree_weight_node& node )
{
	dispatcher.dispatch	( node, *this );
}

void n_ary_tree_animation_node::visit	( n_ary_tree_double_dispatcher& dispatcher, n_ary_tree_addition_node& node )
{
	dispatcher.dispatch	( node, *this );
}

void n_ary_tree_animation_node::visit	( n_ary_tree_double_dispatcher& dispatcher, n_ary_tree_subtraction_node& node )
{
	dispatcher.dispatch	( node, *this );
}

void n_ary_tree_animation_node::visit	( n_ary_tree_double_dispatcher& dispatcher, n_ary_tree_multiplication_node& node )
{
	dispatcher.dispatch	( node, *this );
}

void n_ary_tree_animation_node::visit	( n_ary_tree_double_dispatcher& dispatcher, n_ary_tree_transition_node& node )
{
	dispatcher.dispatch	( node, *this );
}