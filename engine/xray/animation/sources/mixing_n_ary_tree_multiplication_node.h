...
#ifndef N_ARY_TREE_MULTIPLICATION_NODE_H_INCLUDED
#define N_ARY_TREE_MULTIPLICATION_NODE_H_INCLUDED
...
class n_ary_tree_multiplication_node : public n_ary_tree_n_ary_operation_node {
public:
	inline	n_ary_tree_multiplication_node	( u32 const operands_count ) : n_ary_tree_n_ary_operation_node( operands_count ) { }
	inline	n_ary_tree_multiplication_node	( n_ary_tree_multiplication_node const& other ) : n_ary_tree_n_ary_operation_node ( other ) { }
...
#endif // #ifndef N_ARY_TREE_MULTIPLICATION_NODE_H_INCLUDED