...
public:
	inline	physics::vector< island_object* >	&island_objects_pointers	( ) { return m_island_objects_pointers; }
	...
	inline	physics::vector<dxJoint*>			&joints						( ) { return m_joints; }
	inline	physics::vector<dxBody*>			&bodies						( ) { return m_bodies; }
...
private:
	...
	physics::vector< island_object* >			m_island_objects_pointers;
	xray::collision::objects_type*				m_space_collision_results;
	physics::vector< dxJoint* >					m_joints;
	physics::vector< dxBody* >					m_bodies;
