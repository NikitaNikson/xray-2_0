...
template<>
const float IntpTricubic3<float>::ms_aafCRBlend[4][4] =
{
    { 0.0f, -0.5f,  1.0f, -0.5f },
    { 1.0f,  0.0f, -2.5f,  1.5f },
    { 0.0f,  0.5f,  2.0f, -1.5f },
...
template<>
const float IntpTricubic3<float>::ms_aafBSBlend[4][4] =
{
...
template<>
const double IntpTricubic3<double>::ms_aafCRBlend[4][4] =
{
    { 0.0, -0.5,  1.0, -0.5 },
    { 1.0,  0.0, -2.5,  1.5 },
    { 0.0,  0.5,  2.0, -1.5 },
...
template<>
const double IntpTricubic3<double>::ms_aafBSBlend[4][4] =
{
