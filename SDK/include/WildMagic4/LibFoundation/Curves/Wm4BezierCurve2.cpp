    ...
    SingleCurve2<Real>((Real)0.0,(Real)1.0)
{
    ...
    m_akDer1CtrlPoint = WM4_NEW Vector2<Real>[m_iNumCtrlPoints-1];
    ...
    m_akDer2CtrlPoint = WM4_NEW Vector2<Real>[m_iNumCtrlPoints-2];
    ...
    if (iDegree >= 3)
    {
        m_akDer3CtrlPoint = WM4_NEW Vector2<Real>[m_iNumCtrlPoints-3];
...
Vector2<Real> BezierCurve2<Real>::GetPosition (Real fTime) const
{
    ...
    for (int i = 1; i < m_iDegree; i++)
    {
        ...
        kResult = (kResult+m_akCtrlPoint[i]*fCoeff)*fOmTime;
        fPowTime *= fTime;
    }

    kResult += m_akCtrlPoint[m_iDegree]*fPowTime;
...
Vector2<Real> BezierCurve2<Real>::GetFirstDerivative (Real fTime) const
{
    ...
    for (int i = 1; i < iDegreeM1; i++)
    {
        ...
        kResult = (kResult+m_akDer1CtrlPoint[i]*fCoeff)*fOmTime;
        fPowTime *= fTime;
    }

    kResult += m_akDer1CtrlPoint[iDegreeM1]*fPowTime;
...
Vector2<Real> BezierCurve2<Real>::GetSecondDerivative (Real fTime) const
{
    ...
    for (int i = 1; i < iDegreeM2; i++)
    {
        ...
        kResult = (kResult+m_akDer2CtrlPoint[i]*fCoeff)*fOmTime;
        fPowTime *= fTime;
    }

    kResult += m_akDer2CtrlPoint[iDegreeM2]*fPowTime;
...
Vector2<Real> BezierCurve2<Real>::GetThirdDerivative (Real fTime) const
{
    ...
    for (int i = 1; i < iDegreeM3; i++)
    {
        ...
        kResult = (kResult+m_akDer3CtrlPoint[i]*fCoeff)*fOmTime;
        fPowTime *= fTime;
    }

    kResult += m_akDer3CtrlPoint[iDegreeM3]*fPowTime;
