...
{
    m_afLength = WM4_NEW Real[m_iSegments];
    m_afAccumLength = WM4_NEW Real[m_iSegments];
...
class MultipleCurve2<float>;

template WM4_FOUNDATION_ITEM
class MultipleCurve2<double>;
//----------------------------------------------------------------------------
}
