...
void NaturalSpline3<Real>::CreateFreeSpline ()
{
    ...
    Vector3<Real>* akAlpha = WM4_NEW Vector3<Real>[m_iSegments];
    for (i = 1; i < m_iSegments; i++)
    {
    ...
    Vector3<Real>* akZ = WM4_NEW Vector3<Real>[m_iSegments+1];
    Real fInv;
    ...
    m_akB = WM4_NEW Vector3<Real>[m_iSegments];
    m_akC = WM4_NEW Vector3<Real>[m_iSegments+1];
    m_akD = WM4_NEW Vector3<Real>[m_iSegments];
...
void NaturalSpline3<Real>::CreateClampedSpline ()
{
    ...
    Vector3<Real>* akAlpha = WM4_NEW Vector3<Real>[m_iSegments+1];
...
class NaturalSpline3<float>;

template WM4_FOUNDATION_ITEM
class NaturalSpline3<double>;
//----------------------------------------------------------------------------
}
