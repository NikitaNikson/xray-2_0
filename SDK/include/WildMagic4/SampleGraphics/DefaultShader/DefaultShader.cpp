...
WM4_WINDOW_APPLICATION(DefaultShader);
...
bool DefaultShader::OnKeyDown (unsigned char ucKey, int iX, int iY)
{
    ...
    case 's':
    case 'S':
        TestStreaming(m_spkScene,128,128,640,480,"DefaultShader.wmof");
        return true;
    }
...
void DefaultShader::CreateScene ()
{
    ...
    DefaultShaderEffect* pkEffect = WM4_NEW DefaultShaderEffect;
